...
const HtmlWebpackPlugin = requre('html-webpack-plugin'); // Archivo necesario para trabjar con Html

Module.exports = { //Aqui se encuentra toda la configuracion de lo que va a suceder. Modulo para exportar
    entry: './index.js', // Punto de entrada con su direccion. Aqui vive el codigo inicial y de aqui parte al desarrollo
    ...
    plugins: [ // Establecemos los plugins que amos a usar 
